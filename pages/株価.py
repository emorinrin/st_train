...
days = st.sidebar.slider('日数', 1, 50, 20) # 取得するための日数をスライドバーで表示し、daysに代入
...
default_index = ['google', 'amazon', 'facebook', 'apple'] # 最初に表示する企業名を設定
...
if not companies:
    ...
    st.write("株価 (USD)", data.sort_index()) # dataにあるindexを表示
